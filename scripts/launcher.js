...
async function installBun() {
  ...
  try {
    ...
    console.log(
      "✅ Bun installed successfully. You might need to restart your terminal to use it globally.",
    );
    return true;
  } catch (e) {
...
async function main() {
  ...
  if (!hasBun) {
    ...
    const answer = await question(
      "❓ Would you like to install Bun now? (y/n): ",
    );
  ...
  console.log(
    `   Path to manifest: ${path.resolve("src/claude_mcp_plugin/manifest.json")}`,
  );
